...
class LibrosControllerTest < ActionController::TestCase
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post :create, libro: { Autor: @libro.Autor, Descripcion: @libro.Descripcion, Fecha: @libro.Fecha, Nnombre: @libro.Nnombre, Precio: @libro.Precio }
    end
  ...
  test "should update libro" do
    patch :update, id: @libro, libro: { Autor: @libro.Autor, Descripcion: @libro.Descripcion, Fecha: @libro.Fecha, Nnombre: @libro.Nnombre, Precio: @libro.Precio }
    assert_redirected_to libro_path(assigns(:libro))
  end
