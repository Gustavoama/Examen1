...
class DocumentosControllerTest < ActionController::TestCase
  ...
  test "should create documento" do
    assert_difference('Documento.count') do
      post :create, documento: { Fecha: @documento.Fecha, Mi_archivo: @documento.Mi_archivo, Nombre: @documento.Nombre }
    end
  ...
  test "should update documento" do
    patch :update, id: @documento, documento: { Fecha: @documento.Fecha, Mi_archivo: @documento.Mi_archivo, Nombre: @documento.Nombre }
    assert_redirected_to documento_path(assigns(:documento))
  end
