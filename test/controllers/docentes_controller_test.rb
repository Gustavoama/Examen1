...
class DocentesControllerTest < ActionController::TestCase
  ...
  test "should create docente" do
    assert_difference('Docente.count') do
      post :create, docente: { Asistio: @docente.Asistio, Clase: @docente.Clase, Descripcion: @docente.Descripcion, Fecha: @docente.Fecha, Nombre: @docente.Nombre }
    end
  ...
  test "should update docente" do
    patch :update, id: @docente, docente: { Asistio: @docente.Asistio, Clase: @docente.Clase, Descripcion: @docente.Descripcion, Fecha: @docente.Fecha, Nombre: @docente.Nombre }
    assert_redirected_to docente_path(assigns(:docente))
  end
